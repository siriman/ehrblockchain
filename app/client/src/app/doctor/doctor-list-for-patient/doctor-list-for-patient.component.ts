...
export class DoctorListForPatientComponent implements OnInit, OnDestroy {
  ...
  public headerNames = [
    new DisplayVal(DoctorViewRecord.prototype.doctorId, 'Identifiant du medecin'),
    new DisplayVal(DoctorViewRecord.prototype.firstName, 'Prenom'),
    new DisplayVal(DoctorViewRecord.prototype.lastName, 'Nom')
  ];
